...
const PaymentPage = () => {
    ...
    useEffect(() => {
        const fetchPaymentDetails = async () => {
            try {
                const response = await fetch(`https://sharjeel-payment.vercel.app/get-payment-details/${sessionId}`);
                if (!response.ok) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (error) {
            ...
            try {
                ...
                const response = await fetch(`https://sharjeel-payment.vercel.app/api/create-payment/${sessionId}`, {
                    method: 'POST',
                    headers: {
